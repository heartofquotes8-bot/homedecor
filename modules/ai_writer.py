...
Home Decor & Interior Design niche ke liye
"""
...
class AIWriter:
    ...
    def generate_full_post(self, topic: str) -> dict:
        ...
        prompt = f"""
        You are an expert SEO blog writer and Interior Designer. Write a comprehensive, highly engaging, and professional blog post about '{topic}' for an online modern home decor blog.
        The post MUST be detailed and informative. Include styling tips, color palettes, and furniture ideas. Use HTML formatting (<h2>, <h3>, <ul>, <li>, <strong>).
